		...
		<Container className=''>
			...
			<div className='mt-16 sm:mt-52'>
				...
				<section className='mb-16 mt-16 sm:mb-14 sm:mt-20'>
					<div className='h-72 bg-red-50 sm:h-[403px]'>Carrusel</div>
				</section>
				...
				<section className='justify-between sm:flex'>
					...
					<TextSubcontent className='grid max-w-[500px] gap-y-5'>
						<p className='sm:text-right'>
							...
							Its purpose is the transmission of feelings, ideas and perceptions to the minds of others. “What’s on your
							mind?”
						</p>
						<p className='sm:text-right'>
			...
			<div className='mt-40 sm:mb-64 sm:mt-32'>
				...
				<section className='flex-row-reverse justify-between sm:flex'>
					...
					<TextSubcontent className='grid max-w-[500px] gap-y-5'>
						<p>
							<strong>MATINÉ</strong> is the production house of Made By Partners. The name makes reference to the movie
							or theater showings during daytime. <br />
				...
				<Image
					...
					className='dev-cnt absolute right-0 h-[400px] opacity-20'
				/>
			</div>
		</Container>
	</Main_screen>
