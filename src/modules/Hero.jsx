export const Hero = () => {
	return (
		...
		<div
			className='animate-fading-in min-h-hero bg-hero-content-home flex flex-col items-center justify-center gap-y-5 bg-cover bg-center'
			style={{
			...
			<div className='bg-hero-animation-home h-24 w-full bg-cover bg-center sm:w-9/12 lg:w-7/12'></div>
